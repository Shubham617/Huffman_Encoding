...
int bits_io_read_bit (BitsIOFile *bfile) {
  ...
  // unsigned int bytebuffer=1;
   ...
   unsigned int ck=(0|read);
   unsigned int bytebuffer=1;
  // if(read!=ALL_BITS_READ){
